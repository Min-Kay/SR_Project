...
public:
	enum CHANNELID { BGM, PLAYER,UI, EFFECT, PLAYER_EFFECT1, PLAYER_EFFECT2, PLAYER_EFFECT3, ENEMY_EFFECT1, ENEMY_EFFECT2, ENEMY_EFFECT3, WEAPON_EFFECT1, WEAPON_EFFECT2, WEAPON_EFFECT3, ADDITIONAL_EFFECT1, ADDITIONAL_EFFECT2, MAXCHANNEL };
private:
	CSoundMgr();
