...
HRESULT CLevel_StageOne::Ready_Layer_Map()
{
	...
	//	transform->Set_State(CTransform::STATE_POSITION, _float3(0.1f, -2.f, (iWaterZ * 2)));
	...
	//// 물 Test2
	//{
	//	if (FAILED(pGameInstance->Add_GameObject(LEVEL_STAGEONE, TEXT("Layer_Water2"), TEXT("Prototype_GameObject_Water"))))
	//		return E_FAIL;

	//	CGameObject* Water = pGameInstance->Get_GameObject(LEVEL_STAGEONE, TEXT("Layer_Water2"), 0);
	//	CTransform* WaterTrans = (CTransform*)Water->Get_Component(COM_TRANSFORM);
	//	WaterTrans->Scaled(_float3(1.f, 1.f, 1.f));
	//	WaterTrans->Set_State(CTransform::STATE_POSITION, _float3(8.f, 1.f, 8.f));
	//	//CBoxCollider* box = static_cast<CBoxCollider*>(Water->Get_Component(COM_COLLIDER));
	...
	////	CTransform* WaterTrans = (CTransform*)Water->Get_Component(COM_TRANSFORM);
	////	WaterTrans->Scaled(_float3(25.f, 2.f, 5.f));
	////	WaterTrans->Set_State(CTransform::STATE_POSITION, _float3((iWaterZ * 2.5f), 2.f, (_float)iWaterZ * 2.4f));
	...
	//	box->Set_State(CBoxCollider::COLL_SIZE, _float3((_float)iLineX, 1.f, (_float)(iWaterZ * 2.9)));
	//	box->Set_AdditionalPos(_float3(iLineX * 0.5f, 0.f, iWaterZ * 0.5f * 2.6));
