...
enum SHADER_CUBE
{
	SHADER_NONE_CUBE, SHADER_SETCOLOR_CUBE, SHADER_GROWCOLOR_CUBE, SHADER_GRAYCOLOR_CUBE, SHADER_NONE_BLEND_CUBE, SHADER_SETCOLOR_BLEND_CUBE, SHADER_GROWCOLOR_BLEND_CUBE, SHADER_GRAYCOLOR_BLEND_CUBE
};
